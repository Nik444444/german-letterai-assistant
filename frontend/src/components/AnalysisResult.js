            ...
            <div className={`bg-white rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto transform transition-all duration-500 ${
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-white text-opacity-90 text-sm">
                                    Powered by {analysisResult?.llm_provider} • AI-анализ документа
                                </p>
                            </div>
                        </div>
                ...
                <div className="p-8 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        {/* AI Провайдер */}
                        <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-6 text-center transform hover:scale-105 transition-transform">
                            <div className="flex justify-center mb-3">
                                <TrendingUp className="h-5 w-5 text-purple-500" />
                            </div>
                            <h3 className="font-semibold text-gray-900 mb-1">AI Модель</h3>
