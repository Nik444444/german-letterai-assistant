                            ...
                            <div className="flex items-center space-x-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/90 text-lg flex items-center space-x-3">
                                        <span>Powered by {analysisResult?.llm_provider}</span>
                ...
                <div className="p-8 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <FloatingElement delay={0.3}>
                            <GlassCard className="p-6 text-center bg-purple-50 border-2 border-purple-200 transform hover:scale-105 transition-all duration-300">
                                <div className="flex justify-center mb-3">
