                ...
                <div className="relative">
                    <div className="flex items-center space-x-4 mb-4">
                        <div className="flex-shrink-0">
                            <div className="relative">
                                <div className="w-14 h-14 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300">
                                    <MessageCircle className="h-7 w-7 text-white" />
                                </div>
                                <PulsingDot className="absolute -top-1 -right-1 text-green-500 w-4 h-4" />
                            </div>
                        </div>
                        
                        <div className="flex-1">
                            <h3 className="text-xl font-bold mb-1">
                                <GradientText>Telegram Новости</GradientText>
                            </h3>
                            <p className="text-sm text-gray-600 flex items-center space-x-2">
                                <span>@{channelInfo?.name || 'germany_ua_news'}</span>
                                {channelInfo?.status === 'demo' && (
